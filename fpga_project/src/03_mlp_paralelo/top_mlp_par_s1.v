// top_mlp_par_s1.v -- top-level de "Situacion 1" (demo de arquitecturas,
// ver README): red minima 8->12->4, para que el ESP32 en software le gane
// a la FPGA por el overhead fijo de SPI. Mismo protocolo/patron que
// top_mlp_par.v, solo cambia que instancia mlp_engine_par_s1 y que el bus
// de direcciones de pesos es de 13 bits (ver comentario de cabecera de
// top_mlp_par_s2.v para el detalle de por que se ensancho).
module top_mlp_par_s1 (
    input  wire       clk,
    input  wire       sclk,
    input  wire       cs_n,
    input  wire       mosi,
    ...
    // Bus de direcciones de pesos ensanchado a 13 bits: carril=addr_field[15:13],
    // direccion local=addr_field[12:0] (antes 12 bits/carril en [14:12]/[11:0]).
    reg [12:0]       w_ptr;
    reg [2:0]        w_lane;
