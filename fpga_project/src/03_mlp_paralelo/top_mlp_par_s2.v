// top_mlp_par_s2.v -- top-level de "Situacion 2" (demo de arquitecturas,
// ver README): red 130->160->96->32->5 (~39.4K pesos), bastante mas grande
// que el modelo original para que la FPGA gane con mas margen. Mismo
// protocolo que top_mlp_par.v, con dos anchos ensanchados porque este
// modelo ya no entra en los limites viejos:
//   - direccion de pesos: 13 bits en vez de 12 (4936 direcciones/carril,
//     antes el limite era 4096)
//   - direccion de bias (carga Y debug): 9 bits en vez de 8 (293 entradas
//     de bias, antes el limite era 256)
// addr_field (16 bits) se reparte asi para pesos: carril=[15:13],
// direccion=[12:0]. Para debug: sel=[11:9], direccion=[8:0] (se corrio 1
// bit respecto de top_mlp_par.v para no pisar el 9no bit de direccion).
module top_mlp_par_s2 (
    input  wire       clk,
    input  wire       sclk,
    input  wire       cs_n,
    input  wire       mosi,
