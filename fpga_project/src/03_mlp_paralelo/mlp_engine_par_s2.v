// mlp_engine_par_s2.v -- variante de mlp_engine_par.v para "Situacion 2"
// (demo de las 3 arquitecturas, ver README): red 130->160->96->32->5,
// bastante mas grande que el modelo original (130->128->64->32->5) para
// que la FPGA le gane al ESP32 con mas margen todavia. Mismo patron de
// FSM/pipeline (identico a mlp_engine_par.v, incluidos los arreglos de
// carril/decodificadores explicitos) -- solo cambia la tabla de capas, el
// tamano de las memorias, y el bus de direcciones de pesos (13 bits en vez
// de 12, porque este modelo ya no entra en 4096 direcciones por carril).
//
// MAPA DE MEMORIA DE PESOS POR CARRIL:
//   Capa 0 (130->160, 20 olas): direcciones locales    0..2599  (20*130)
//   Capa 1 (160->96,  12 olas): direcciones locales 2600..4519  (12*160)
//   Capa 2 ( 96->32,   4 olas): direcciones locales 4520..4903  ( 4*96)
//   Capa 3 ( 32-> 5,   1 ola ): direcciones locales 4904..4935  ( 1*32)
// MAPA DE BIAS: direccion plana 0..292 (160+96+32+5).
module mlp_engine_par_s2 (
    input  wire clk,
    ...
    input  wire [8:0]  dbg_rd_addr, // 9 bits: bias_mem tiene 293 entradas, no entra en 8 bits
    ...
    reg signed [7:0] bias_mem  [0:292];
    reg signed [7:0] input_mem [0:129];
    reg signed [7:0] h1_mem    [0:159];
    reg signed [7:0] h2_mem    [0:95];
    ...
    always @(*) begin
        case (layer_idx)
            2'd0: begin in_count=8'd130; out_count=8'd160; num_waves=5'd20; layer_weight_base=13'd0;    layer_bias_base=9'd0;   end
            2'd1: begin in_count=8'd160; out_count=8'd96;  num_waves=5'd12; layer_weight_base=13'd2600; layer_bias_base=9'd160; end
            2'd2: begin in_count=8'd96;  out_count=8'd32;  num_waves=5'd4;  layer_weight_base=13'd4520; layer_bias_base=9'd256; end
            default: begin in_count=8'd32; out_count=8'd5; num_waves=5'd1;  layer_weight_base=13'd4904; layer_bias_base=9'd288; end
        endcase
    end
